...
@section('title', $category? $category->name : 'Shop')

@section('breadcrumb')
    @parent
    <li>{{ $category? $category->name : 'Shop' }}</li>
@endsection
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="product-image">
                                                ...
                                                <div class="button">
                                                    <a href="{{ $product->url }}" class="btn"><i
                                            ...
                                            <div class="product-info">
                                                ...
                                                <div class="price">
                                                    ...
                                                    <span class="discount-price">{{ Money::format($product->compare_price) }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
